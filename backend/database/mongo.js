...
function connect(locals) {
    ...
    const uri =`mongodb+srv://adam84miller:${process.env.DB_PASSWORD}@cluster0.g4qc0.mongodb.net/demo?retryWrites=true&w=majority`
    ...
    .then((connection) => {
        ...
        // named these accordingly to make them easier to locate in the file
